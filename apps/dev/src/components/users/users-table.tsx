...
import { fmtDate, statusMeta } from "@/lib/dev-data/display";
import { templateDisplayName } from "@/lib/dev-data/templates";
import type { DevUser, UserStatus } from "@/lib/dev-data/types";
        ...
        <Table>
          ...
          <TBody>
            {filtered.map((u) => {
              ...
              return (
                <TR key={u.id} interactive onClick={() => router.push(`/users/${u.id}`)}>
