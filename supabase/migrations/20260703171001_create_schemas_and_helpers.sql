...
--
-- hub/dev/staging 을 우선 사용하고, work/mna/project/fund/management 는 이후 Phase에서
...
-- dev 스키마(계정·권한·시스템 담당)에 두어, 모든 업무 테이블의 BEFORE UPDATE 트리거에서 재사용한다.
...
COMMENT ON FUNCTION dev.set_updated_at() IS
