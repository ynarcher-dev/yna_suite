...
이 폴더는 Y&A Suite를 만들고 운영하기 위한 기준 문서 모음입니다.
...
- [yna_suite_planning.md](./yna_suite_planning.md): 전체 플랫폼 기획과 Hub/Dev/Work/Fund/M&A/Project/Management의 관계
- [yna_suite_phase1_scope.md](./yna_suite_phase1_scope.md): Phase 1에서 만들 것과 미룰 것
- [yna_suite_existing_source_alignment.md](./yna_suite_existing_source_alignment.md): 기존 `yna-db`, `yna-matching`을 새 Suite에 반영하는 기준
- [yna_suite_information_architecture.md](./yna_suite_information_architecture.md): 서비스별 메뉴, 화면 구조, 라우트 기준

## Phase 1 구현 기준

- [yna_suite_hub_dev_functional_spec.md](./yna_suite_hub_dev_functional_spec.md): Hub와 Dev의 화면/기능 명세
- [yna_suite_api_contracts.md](./yna_suite_api_contracts.md): Hub/Dev/도메인 앱 사이의 API와 RPC 계약
...
- [yna_suite_environment_deployment.md](./yna_suite_environment_deployment.md): local/dev/staging/production 환경과 도메인 전략
